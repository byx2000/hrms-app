...
<template>
  <el-dialog title="添加员工" :visible.sync="isOpen" width="40%" :before-close="beforeClose" @open="onOpen">
    <!-- <el-form label-width="80px" label-position="left" :rules="rules" :model="emp" ref="form">

      <el-row type="flex" justify="space-between">
        <el-col :span="11">
          <el-form-item label="工号" prop="empNo">
            <el-input v-model="emp.empNo"/>
          </el-form-item>
        </el-col>
        <el-col :span="11">
      ...
      <el-row type="flex" justify="space-between">
        ...
        <el-col :span="11">
          <el-form-item label="年龄" prop="age">
            <el-input type="age" v-model.number="emp.age"/>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row type="flex" justify="space-between">
        <el-col :span="11">
          <el-form-item label="部门" prop="deptId">
            <el-select v-model="emp.deptId" @change="onDeptChange">
